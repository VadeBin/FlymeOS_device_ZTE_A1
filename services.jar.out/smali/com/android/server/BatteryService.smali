...
.field mEnabledState_Charging:Z

.field mEnabledState_LowBattery:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 174
    iput-object v3, p0, Lcom/android/server/BatteryService;->mDialog:Landroid/app/AlertDialog;

    .line 175
    iput-object v3, p0, Lcom/android/server/BatteryService;->pd:Landroid/app/ProgressDialog;

    .line 177
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mEnabledState_LowBattery:Z

    .line 178
    iput-boolean v2, p0, Lcom/android/server/BatteryService;->mEnabledState_Charging:Z

    .line 912
    new-instance v0, Lcom/android/server/BatteryService$16;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$16;-><init>(Lcom/android/server/BatteryService;)V
...
.method static synthetic access$1300(Lcom/android/server/BatteryService;)Landroid/app/AlertDialog;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method static synthetic access$1302(Lcom/android/server/BatteryService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BatteryService;
...
.method private showTemperatureProgressDialog(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/BatteryService$8;-><init>(Lcom/android/server/BatteryService;Landroid/content/Context;)V
...
.method private updateBatteryWarningLevelLocked()V
    ...
    iget v5, p0, Lcom/android/server/BatteryService;->mCriticalBatteryLevel:I
    ...
    const v6, #android:integer@config_lowBatteryCloseWarningBump#t
    ...
    const-string v5, "mEnabledState_LowBattery"
    ...
    const-string v5, "mEnabledState_Charging"
    ...
    :cond_2
    iput-boolean v4, p0, Lcom/android/server/BatteryService;->mEnabledState_Charging:Z

    invoke-direct {p0, v3}, Lcom/android/server/BatteryService;->processValuesLocked(Z)V
...
.method public onBootPhase(I)V
    ...
    invoke-direct {v0, p0, v6}, Lcom/android/server/BatteryService$2;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V
    ...
    invoke-virtual {v3, v6, v8, v0, v9}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    new-instance v2, Lcom/android/server/BatteryService$3;

    iget-object v6, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    invoke-direct {v2, p0, v6}, Lcom/android/server/BatteryService$3;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V

    .local v2, "observer_lb":Landroid/database/ContentObserver;
    iget-object v6, p0, Lcom/android/server/BatteryService;->mContext:Landroid/content/Context;
    ...
    .local v5, "resolver_lb":Landroid/content/ContentResolver;
    const-string v6, "mEnabledState_LowBattery"
    ...
    invoke-virtual {v5, v6, v8, v2, v9}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    new-instance v1, Lcom/android/server/BatteryService$4;

    iget-object v6, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    invoke-direct {v1, p0, v6}, Lcom/android/server/BatteryService$4;-><init>(Lcom/android/server/BatteryService;Landroid/os/Handler;)V

    .local v1, "observer_charge":Landroid/database/ContentObserver;
    iget-object v6, p0, Lcom/android/server/BatteryService;->mContext:Landroid/content/Context;
    ...
    .local v4, "resolver_charge":Landroid/content/ContentResolver;
    const-string v6, "mEnabledState_Charging"
    ...
    invoke-virtual {v4, v6, v8, v1, v9}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    .end local v1    # "observer_charge":Landroid/database/ContentObserver;
    .end local v2    # "observer_lb":Landroid/database/ContentObserver;
    .end local v3    # "resolver":Landroid/content/ContentResolver;
    .end local v4    # "resolver_charge":Landroid/content/ContentResolver;
    .end local v5    # "resolver_lb":Landroid/content/ContentResolver;
    :cond_0
    return-void
