...
# instance fields
.field private final AUTO_LAUNCH_RESTRICTIONS:Ljava/lang/String;

.field private final AUTO_LAUNCH_RESTRICTIONS_BACKUP:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    .line 3880
    const-string v0, "auto-launch-restrictions.xml"

    iput-object v0, p0, Lcom/android/server/pm/Settings;->AUTO_LAUNCH_RESTRICTIONS:Ljava/lang/String;

    .line 3881
    const-string v0, "auto-launch-restrictions-backup.xml"

    iput-object v0, p0, Lcom/android/server/pm/Settings;->AUTO_LAUNCH_RESTRICTIONS_BACKUP:Ljava/lang/String;
...
.method public disableAutoLaunch(Landroid/content/Context;Ljava/util/ArrayList;)V
    .locals 14
    .param p1, "context"    # Landroid/content/Context;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/util/ArrayList",
            "<",
            "Lcom/android/server/pm/AutoLaunchInfo;",
            ">;)V"
        }
    .end annotation
    ...
    .prologue
    .line 3884
    .local p2, "infos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/AutoLaunchInfo;>;"
    const-string v10, "PackageSettings"

    const-string v11, "disableAutoLaunch start"
    ...
    const-string v11, "auto-launch-restrictions.xml"

    invoke-direct {v0, v10, v11}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 3888
    .local v0, "autoLaunchStateFile":Ljava/io/File;
    new-instance v1, Ljava/io/File;
    ...
    const-string v11, "auto-launch-restrictions-backup.xml"

    invoke-direct {v1, v10, v11}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 3891
    .local v1, "autoLaunchStateFilebakeup":Ljava/io/File;
    ...
    invoke-interface {v8, v9, v10}, Lorg/xmlpull/v1/XmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    const-string v11, "package-restrictions"
    ...
    check-cast v7, Lcom/android/server/pm/AutoLaunchInfo;

    .line 3913
    .local v7, "info":Lcom/android/server/pm/AutoLaunchInfo;
    const/4 v10, 0x0
    ...
    invoke-virtual {v7}, Lcom/android/server/pm/AutoLaunchInfo;->getPackageName()Ljava/lang/String;
    ...
    .line 3917
    invoke-virtual {v7}, Lcom/android/server/pm/AutoLaunchInfo;->getComponents()Ljava/util/ArrayList;
    ...
    .end local v7    # "info":Lcom/android/server/pm/AutoLaunchInfo;
    ...
    const-string v11, "Unable to write auto launch state, current changes will be lost at reboot"
    ...
    const-string v12, "unable to create autoLaunchStateFile "
    ...
    .restart local v7    # "info":Lcom/android/server/pm/AutoLaunchInfo;
    ...
    const-string v11, "disableAutoLaunch end"
