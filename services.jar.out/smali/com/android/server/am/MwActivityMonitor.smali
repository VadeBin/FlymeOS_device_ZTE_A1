...
.method public blockByRunningActivity(Ljava/lang/String;Lcom/android/server/am/ProcessRecord;Landroid/content/Intent;[Lcom/android/server/am/ActivityRecord;Landroid/content/pm/ActivityInfo;)I
    ...
    const-string v10, "blockByRunningActivity processName = "
    ...
    .line 163
    .local v4, "nextComponentName":Ljava/lang/String;
    iget-object v8, p0, Lcom/android/server/am/MwActivityMonitor;->mRunningActivity:Ljava/util/ArrayList;
    ...
    .line 166
    .local v6, "runningAc":Lcom/android/server/am/ActivityRecord;
    const/4 v8, 0x0
    ...
    .line 171
    .local v3, "isRunningFloat":Z
    const/4 v2, 0x0

    .line 172
    .local v2, "isNextFloat":Z
    ...
    .line 232
    .end local v2    # "isNextFloat":Z
    .end local v3    # "isRunningFloat":Z
    .end local v5    # "nextFlag":I
    .end local v6    # "runningAc":Lcom/android/server/am/ActivityRecord;
    .end local v7    # "runningFlag":I
    :goto_1
    return v8

    .line 187
    .restart local v2    # "isNextFloat":Z
    .restart local v3    # "isRunningFloat":Z
    .restart local v5    # "nextFlag":I
    .restart local v6    # "runningAc":Lcom/android/server/am/ActivityRecord;
    .restart local v7    # "runningFlag":I
    :cond_2
    if-eqz p2, :cond_3

    iget-object v8, v6, Lcom/android/server/am/ActivityRecord;->processName:Ljava/lang/String;
    ...
    const-string v10, "blockByRunningActivity :  caller apps are same "
    ...
    const-string v10, "blockByRunningActivity :  2 shortComponentNames are same "
    ...
    invoke-virtual {v8, p3, v6}, Lcom/android/server/am/ActivityStack;->findActivityLocked(Landroid/content/Intent;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v10, "blockByRunningActivity :  3 exist same activity in resumed stack "
    ...
    const-string v10, "blockByRunningActivity : "
    ...
    const-string v10, " has activity for resumed : "
    ...
    const-string v10, ". Therefore, don\'t be launched "
